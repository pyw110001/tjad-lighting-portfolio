...
一个以“**建筑化照明**”为核心的高品质作品型品牌网站。依托同济大学建筑设计研究院（TJAD）建筑照明所 2023 年团队画册与代表性实践资料，展示 29 个代表项目、11 个重点精选案例，以及重构升级的 **LIGHT LAB 光的实验室**（光场、像素立面、昼夜场景、色温工作室）与 3D 视差海报等深度互动体验。
...
需要 Node.js 20 或更高版本；浏览器端自动化测试使用系统安装的 Google Chrome。
